...
class Product(models.Model):
    ...
    def get_average_rating(self):
        ...
        if reviews:
            total_ratings = sum([int(review.review_rating) for review in reviews])
...
class CartOrderItems(models.Model):
    ...
    class Meta:
        verbose_name_plural='8. Orders details'
...
class ProductReview(models.Model):
    ...
    '''
    def get_review_rating(self):
        return str(self.review_rating) if self.review_rating is not None else '0'
    '''
